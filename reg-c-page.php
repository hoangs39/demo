    ...
    <div class="registration-form">
      ...
      <section>
        <ul class="pagination pagination-sm justify-content-center">
          <li class="page-item"><a href="#" class="page-link">Customers</a></li>
      ...
      <p class=""></p>
      <!-- customers -->
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="Customers-registration">
        <!--//User's name//-->
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="name" placeholder="Enter Your Name" name="name" value="<?php echo $_Name;?>">
          <p class="err-msg"><?php if($nameErr!=1){ echo $nameErr; } ?></p>
        </div>
        <!--// Address//-->
        <div class="form-group">
          <label for="address">Address:</label>
          <input type="text" class="form-control" id="address" placeholder="Enter email" name="address" value="<?php echo $_address;?>">
